 ...
 * @author JoseGuerra
 */
public class Save_New_View extends javax.swing.JFrame {

    /**
     * Creates new form Save_New_View
     */
    public Save_New_View() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Save a New Gif");
        jPanel5.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 30, -1, -1));
        ...
        txt_tipo.setForeground(new java.awt.Color(54, 33, 89));
        txt_tipo.setBorder(null);
        txt_tipo.setDisabledTextColor(new java.awt.Color(204, 204, 204));
        jPanel5.add(txt_tipo, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 120, 270, 30));
        ...
        btn_guardar.setBackground(new java.awt.Color(54, 33, 89));
        btn_guardar.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        btn_guardar.setForeground(new java.awt.Color(204, 204, 204));
        btn_guardar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/icons/icons8_Save_20px_1.png"))); // NOI18N
        btn_guardar.setText("Save Gif");
        btn_guardar.setContentAreaFilled(false);
        btn_guardar.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        panelBtn2.add(btn_guardar, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 120, 40));
        ...
        jPanel6.add(panelBtn3, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 10, 120, 40));

        jPanel5.add(jPanel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 320, 280, 70));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Save_New_View.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Save_New_View().setVisible(true);
            }
        });
    }
