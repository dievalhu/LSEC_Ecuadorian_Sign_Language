 ...
 * @author JoseGuerra
 */
public class Database_New_View extends javax.swing.JFrame {

    /**
     * Creates new form Save_New_View
     */
    public Database_New_View() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Set the database configuration");
        ...
        jLabel6.setText("Database passord");
        ...
        jPanel5.add(jSeparator6, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 220, 270, 10));

        txt_dbname.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        txt_dbname.setForeground(new java.awt.Color(54, 33, 89));
        txt_dbname.setBorder(null);
        txt_dbname.setDisabledTextColor(new java.awt.Color(204, 204, 204));
        jPanel5.add(txt_dbname, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 260, 270, 30));
        ...
        jPanel5.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 240, -1, -1));

        jSeparator7.setBackground(new java.awt.Color(54, 33, 89));
        jSeparator7.setForeground(new java.awt.Color(54, 33, 89));
        jPanel5.add(jSeparator7, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 290, 270, 10));
        ...
        jLabel12.setText("Database username");
        ...
        jPanel5.add(jSeparator10, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 150, 270, 10));
        ...
        panelBtn2.add(btn_ok, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 100, 40));

        jPanel6.add(panelBtn2, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 10, 100, 40));

        jPanel5.add(jPanel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 320, 280, 70));

        txt_username.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        txt_username.setForeground(new java.awt.Color(54, 33, 89));
        txt_username.setBorder(null);
        txt_username.setDisabledTextColor(new java.awt.Color(204, 204, 204));
        jPanel5.add(txt_username, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 120, 270, 30));

        txt_password.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        txt_password.setForeground(new java.awt.Color(54, 33, 89));
        txt_password.setBorder(null);
        jPanel5.add(txt_password, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 190, 270, 30));

        jPanel3.add(jPanel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 0, 400, 430));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Database_New_View.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Database_New_View().setVisible(true);
            }
        });
    }
    ...
    public static javax.swing.JTextField txt_dbname;
